        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
             ...
             <li><a href="#chat-with-maggie" onClick={(e) => handleNavClick(e, 'chat-with-maggie')} className="text-gray-400 hover:text-white transition duration-300">Chat with Maggie</a></li>
